<x-frontend-layout>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen px-4 mx-auto leading-8 text-center cursor-pointer select-none max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="">
            ...
            <div class="top-0 right-0 items-center justify-center hidden gap-2 px-6 py-4 sm:inline-flex">
                ...
                <a
                    href="{{ route('register') }}"
                    class="text-sm text-gray-800 dark:text-gray-900 px-4 py-1.5 bg-secondary rounded-md shadow-md shadow-secondary/60"
                >Register</a>
                @endif
                @endauth
            </div>
